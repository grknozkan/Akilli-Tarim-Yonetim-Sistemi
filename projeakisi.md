...
* 🗄️ GitHub reposu oluşturuldu, branch koruma kuralları (main) ayarlandı.
* 🎓 Ekibe iş akışı eğitimi verildi.
* 📄 Proje akış dokümanı oluşturuldu.
* 🔬 Proje için uygun teknolojiler araştırıldı ve değerlendirildi.
